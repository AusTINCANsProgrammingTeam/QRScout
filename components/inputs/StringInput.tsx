...
export default function StringInput(data: StringInputProps) {
  ...
  return (
    <textarea
      className="focus:shadow-outline w-full capslock appearance-none break-words break-all rounded border py-2 px-3 leading-tight text-gray-700 shadow focus:outline-none"
